  ...
  return (
    <aside className="hidden lg:flex flex-col w-60 shrink-0 h-[calc(100vh-4rem)] sticky top-16 border-r border-red-950/40 bg-[#070911] p-4 justify-between overflow-y-auto select-none z-30">
                ...
                className={({ isActive }) =>
                  `flex items-center gap-3.5 px-4 py-2.5 rounded-2xl text-xs font-semibold transition-all duration-200 ${
                    isActive
                      ...
                      : 'text-zinc-400 hover:text-white hover:bg-red-950/30'
                  }`
                }
              >
      ...
      <div className="space-y-4 pt-4 border-t border-red-950/40">
        <div className="p-3.5 rounded-2xl bg-gradient-to-br from-[#1f060b] to-[#0c0407] border border-red-500/30 relative overflow-hidden group shadow-lg shadow-red-950/30">
          <div className="absolute -right-3 -top-3 w-16 h-16 bg-red-500/15 rounded-full blur-xl group-hover:bg-red-500/25 transition-all" />
          <div className="flex items-center gap-3 mb-2.5">
            ...
            <div>
              <p className="text-[11px] font-bold text-white leading-tight">Need Help?</p>
              <p className="text-[10px] text-zinc-400">Ask our AI Chatbot</p>
            </div>
          </div>
          <button
            type="button"
            onClick={onChatbotOpen}
            className="w-full py-2 px-3 rounded-xl bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-500 hover:to-rose-500 text-white text-[11px] font-bold flex items-center justify-center gap-1.5 shadow-md shadow-red-600/30 transition-all hover:scale-[1.02] active:scale-98"
          >
            <span>Chat Now</span>
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-3 text-zinc-400">
            <a href="https://discord.com" target="_blank" rel="noopener noreferrer" className="hover:text-red-400 transition-colors" aria-label="Discord">
            ...
            <a href="https://x.com" target="_blank" rel="noopener noreferrer" className="hover:text-red-400 transition-colors" aria-label="X / Twitter">
            ...
            <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="hover:text-red-500 transition-colors" aria-label="YouTube">
