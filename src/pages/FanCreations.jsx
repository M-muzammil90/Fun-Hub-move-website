...
export default function FanCreations() {
  ...
  return (
    <div className="space-y-10 pb-20 max-w-7xl mx-auto">
      <div className="relative rounded-3xl overflow-hidden border border-white/[0.08] bg-gradient-to-r from-[#170e28] via-[#090d16] to-[#0f172a] p-6 sm:p-12 shadow-2xl">
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-4 max-w-xl">
            ...
            <h1 className="text-3xl sm:text-5xl font-black text-white tracking-tight font-display">
              Fan Articles & <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">Creations</span>
            </h1>
          ...
          <Link
            to="/submit"
            className="inline-flex items-center gap-2 px-6 py-3.5 rounded-2xl bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white font-bold text-xs sm:text-sm shadow-xl shadow-purple-600/30 transition-all hover:scale-105 active:scale-95 shrink-0 self-start md:self-auto"
          >
      ...
      <div className="flex flex-col sm:flex-row gap-3 p-4 bg-[#0c101d] border border-white/[0.08] rounded-2xl">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-black/50 border border-white/10 rounded-xl text-xs text-white placeholder-zinc-500 focus:outline-none focus:border-purple-500"
          />
        </div>
        ...
        <select
          ...
          className="px-3.5 py-2 bg-black/50 border border-white/10 rounded-xl text-xs text-zinc-200 focus:outline-none focus:border-purple-500"
        >
